...
const CreateRecipeCard = ({title,description,ImageSrc, ...props} : React.HTMLAttributes<HTMLDivElement> & {title: string, description: string, ImageSrc: string}) => {
  return (
    <div {...props} className='w-52 h-60 bg-gray-100 flex flex-col justify-center items-center p-4 rounded-xl shadow-lg cursor-pointer
