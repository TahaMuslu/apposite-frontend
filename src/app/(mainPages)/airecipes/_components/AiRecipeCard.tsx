...
const AiRecipeCard = ({ ImageSrc, aiRecipe }: { ImageSrc: string, aiRecipe: any; }) => {
  ...
  return (
    <div onClick={() => router.push("/airecipedetail/" + aiRecipe.id)} className='w-full h-32 bg-white shadow-lg rounded-xl grid grid-cols-12 cursor-pointer hover:bg-gray-100 active:bg-gray-200 active:duration-150 transition-colors duration-300'>
