...
const Home = () => {
  const [mealOfTheWeek, setMealOfTheWeek] = React.useState<any>(null);
  const [mostLikedRecipes, setMostLikedRecipes] = React.useState<any[]>([]);
  const [newRecipes, setNewRecipes] = React.useState<any[]>([]);
